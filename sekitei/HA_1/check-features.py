...
for bs in range(0, boot_strap_cnt):
    array = ["лошара", "думал, я буду быстрым?", "подождешь", "мда... программист из тебя так себе", "ха-ха",
             "до свадьбы напечатается", "рукожопик", "иди лучше смузи попей", "че зыришь? нет, я еще не посчитался",
             "не расстаивайся, ты  будешь работать в яндексе. а яндекс-еде"]
